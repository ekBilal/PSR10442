...
namespace PSR10442.Web.Controllers
{
    ...
    public class UserProfileController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            try
            {
                ...
                var result = await activeDirectoryClient.Users
                    ...
                    .ExecuteAsync();
                 user = result.CurrentPage.ToList().First();
		...
		public static async Task<string> GetToken()
		{
			...
			// Initialiser AuthenticationContext avec le cache de jetons de l'utilisateur connecté, tel qu'il figure dans la base de données de l'application
			AuthenticationContext authenticationContext = new AuthenticationContext(aadInstance + tenantID, new ADALTokenCache(signedInUserID));
			AuthenticationResult authenticationResult = await authenticationContext.AcquireTokenSilentAsync("https://ephec.onmicrosoft.com/PSR10442.API", clientcred, new UserIdentifier(userObjectID, UserIdentifierType.UniqueId));
			return authenticationResult.AccessToken;
		}
